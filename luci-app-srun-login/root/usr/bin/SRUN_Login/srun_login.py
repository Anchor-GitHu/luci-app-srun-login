...
def main():
    ...
    parser.add_argument("--username", type=str, default="", help="校园网账号（学号）")
    parser.add_argument("--password", type=str, default="", help="校园网密码")
    ...
    if args.logout:
        ...
        if not args.username or not args.password:
            parser.error("登录需要提供 --username 和 --password")
